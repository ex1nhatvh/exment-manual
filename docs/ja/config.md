...
- 既定値 : (なし)
- 役割 : 二次元バーコード新規作成、二次元バーコードダウンロード、二次元バーコード読込ボタンの「二次元バーコード」の日本語表示名を設定します。特に指定がない場合は「二次元バーコード」とします。

#### ボタン表示名（英語）
- 設定キー : EXMENT_TEXT_QR_BUTTON_JA
- 既定値 : (なし)
- 役割 : 二次元バーコード新規作成、二次元バーコードダウンロード、二次元バーコード読込ボタンの「二次元バーコード」の日本語表示名を設定します。特に指定がない場合は「2D barcode」とします。